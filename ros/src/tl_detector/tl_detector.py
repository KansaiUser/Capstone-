...
class TLDetector(object):
    def __init__(self):
        ...
        #I can use that to figure it out what the light state is instead of using a classifier. 
        # this is not available on a real car
...
#        y = pose.position.y
    ...
    def get_light_state(self, light):
        ...
        # for testing just use the info from the simulator. For real case classification is needed
        return light.state
    ...
    def process_traffic_lights(self):
        ...
        closest_light = None
        line_wp_idx = None    # closest traffic line for the traffic light
        ...
        if(self.pose):
            ...
            for i, light  in enumerate(self.lights):
                ...
                # find closes top line waypoint index
